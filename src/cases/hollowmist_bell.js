...
Hemlock followed you at a distance, perching on doorframes, saying nothing, watching everything. You got the feeling he was grading your curiosity.
...
"I told you," Hemlock said. He was on the bannister behind you, feathers puffed against the chill. "That is not a room you visit without your aunt's permission. That is a room that visits YOU if you are not careful."
...
Hemlock sighed. "We have been summoned. But now you have seen it through the keyhole, and you cannot unsee it. That changes things." He flew downstairs. You took one last look at the cold door and followed.
...
Hemlock landed on the windowsill. He looked at the journal, open in your hands. He looked at the back door. He looked at you. "This," he said, "is a spectacularly bad idea." He paused. "I'm coming."`,
  vocab: { Thirteen:"The number that means something has gone wrong with the bell" },
...
Viola was quiet for a long time. "She stopped him. The last time he came. She succeeded and she did not come back from succeeding." She stood up. "That's three. Go to the bell tower. Something was left there last night and I need to know what it is. Take Hemlock. Be **careful**. And {NAME}? Come home before dark."`,
...
"Faster," said Hemlock, from somewhere above you.
...
"That is blood," Hemlock said, landing beside it. "Left on purpose. That is a **signature**, not an accident."
...
Hemlock went rigid. "Do NOT touch that with bare hands. That feather is a **conduit**. If you touch it, whatever left it here will know you exist. It will see you. It will know where you are."
...
Hemlock was staring at you. Every feather on his body was standing on end. "Oh no," he whispered. "{NAME}. He knows you're here now. He saw your face. He heard your name."

"How does he know my name?"

"Because the feather is a piece of HIM, and when you touched it, he touched YOU. Everything you are. Name, face, memories, all of it, for one second, open like a book." Hemlock's voice was tight with something you had never heard from him before: fear.
...
Hemlock was frozen on the ledger stand. You were alone in this conversation.`,
...
Hemlock dropped from the rafters. "He doesn't know it was you," he whispered. "He knows SOMEONE took the feather. He suspects Viola. He does not know about YOU. That, {NAME}, is the most **valuable** thing we have right now."`,
  ...
  companion: `He does not know it was you. That is an advantage. Protect it.`,
  choices: [
...
"Child," she called out. Her voice cracked. "Child, WAIT."`,
  vocab: { blank:"Completely empty, with nothing on it" },
...
"Don't look," Hemlock said. "Keep walking."
...
At the door, she put one hand on your shoulder. "Be clever, {NAME}. He's been doing this longer than this town has been standing."`,
  ...
  companion: `A workshop. He needs a workspace. Hemlock has eyes and wings. Hemlock will find it.`,
...
Hemlock was very quiet. Then: "Don't touch the bottle. If you break it here, she's freed but he escapes. He has to be mid-ritual when it breaks. That's the only way to send him back and free her at the same time."
...
But Hemlock was not celebrating. He was staring at the shattered bottle, feathers flat with dread. "You freed her," he said. "That's good. But the bottle broke without the ritual in progress. He wasn't connected to it. He felt it shatter and now he KNOWS, and he is going to move on the owl immediately, tonight, right now, and he is going to be **furious**."
...
"He's going for the owl NOW," Hemlock said. "Right now. Not at midnight. Now. Because we took his prize and he is going to take the next one before we can stop him." He looked at you. "Run. HUNTER'S RIDGE. We do not have time for a plan. We have time for running."
...
Hemlock landed on the table. "I have one question. {NAME}, have you ever thrown anything accurately?"

"I won a stuffed bear at a carnival," you said. "Throwing baseballs at bottles."

Hemlock looked at Viola. "Bottles," he said. "Well. That's **thematically** appropriate."`,
...
The forest was dark. The pines were old and enormous. Viola navigated without hesitation. You tripped on roots twice. Hemlock, unhelpfully, said "tree root" both times, approximately one second too late.

The clearing appeared like a held breath. An oval of wet grass. A flat stone in the center. Viola pointed to the fallen log. You crouched behind it, iron nail cold in your fist. She moved to the treeline. Hemlock vanished into the canopy.
...
Hemlock, high above, gave a short call. A signal: he hasn't noticed you.
...
He reached for the bottle. Viola shouted. Hemlock dove from the canopy like a black **missile**, talons out, and raked across Blackthorn's hand. He screamed, a sound that was not from any throat, and the bottle slipped from his fingers and hit the flat stone.
...
A small orange cat sat beside her, tail twitching. "I was in that THING for TWO DAYS. There were no MICE."`,
  ...
  companion: `You threw early. He moved. Hemlock intervened. Your aunt blocked. You hit it on the second try. This was NOT the plan. It worked anyway. I need to lie down.`,
  choices: [
...
Hemlock descended from the canopy. He looked at you. "Not bad," he said. "For a first day."`,
...
Hemlock landed on the stone beside her. He pressed his shoulder against her wing. He did not speak. He just held her steady.
...
Just twelve.`,
  ...
  endEmoji: "📓",
  endMessage: "You snuck out, touched what you shouldn't have, faced a creature older than the town, and threw an iron nail in the dark with a shaking hand. Marmalade is home and furious about breakfast. Silvia is safe. Hemlock says 'not bad,' which from him is basically a love letter. And in the Field Journal, in your own handwriting: your name. 📓⚡🌫️",
},
